...
namespace BD
{
    ...
    {
        Task<DBEntity> ExcecuteAsync(string sp, object Param = null, int? Timeout = null);
        Task<IEnumerable<dynamic>> QueryAsyn(string sp, object Param = null, int? Timeout = null);
